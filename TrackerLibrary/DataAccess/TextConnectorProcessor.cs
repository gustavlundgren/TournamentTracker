...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    ...
    {
        /// <summary>
        /// Creates a file name at the path C:\data\TournamentTracker\fileName.csv
        /// with the specified name
        /// </summary>
        /// <param name="fileName">name of the save file to create</param>
        /// <returns>returns the full path to the save file</returns>
        ...
        public static void SaveToPeopleFile(this List<PersonModel> models, string fileName)
        {
            ...
            {
                lines.Add($"{p.Id},{p.FirstName},{p.LastName},{p.Email},{p.phone}");
            }
        ...
        public static void SaveRoundsToFile(this TournamentModel model, string matchupFile, string matchupEntryFile)
        {
            ...
            // Get id for the entry and save it
        ...
        {
            // goal --> Rounds - id^id^id^id^id^id^id^id|id^id^id^id|id^id
            // The Layout of the Matchup saving in the textfile should look like this after this method
            // The example above is a tournament starting with 8 teams
